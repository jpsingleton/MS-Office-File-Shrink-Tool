@echo off
REM This script decompresses an office 2007/2010 file and repacks it smaller. It then zips the resulting file. 
REM You could call the other script, but cloning the code isolates any changes that may be made and makes it easier to follow.
...
REM zip the file
echo.
echo Zipping: %~n1_shrunk
START "Zipping..." /MIN /BELOWNORMAL /WAIT 7za a -tzip "%~dp1%~n1_shrunk%~x1.zip" "%~dp1%~n1_shrunk%~x1" -mx9 -ssw
